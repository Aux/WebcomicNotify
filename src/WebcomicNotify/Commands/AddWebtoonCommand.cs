...
{
    public class AddWebtoonCommand : CliCommand
    {
        ...
        public AddWebtoonCommand()
            : base("webtoon", "Add a webtoons comic to the service.")
        {
            Aliases.Add("webtoons");
            Options.Add(Query);
            Options.Add(Url);
            Options.Add(Webhook);
        ...
        private Task<int> ExecuteAsync(ParseResult result, IHost host)
        {
            ...
            logger.LogInformation("Executed add webtoons command");
